...
using VVVV.STim.Nodes.Interaction;
...
using VVVV.STim.Nodes.Util;
using System.Diagnostics;
using VVVV.STim.Nodes.Converters;

namespace VVVV.STim.Nodes.Status
{
	public class StatusController
	{
		...
		public StatusController(Dispatcher uiDispatcher, log4net.ILog visitLogger, log4net.ILog statusLogger)
		{
			this.visitLogger = visitLogger;
			this.statusLogger = statusLogger;
			_dispatcher = uiDispatcher;
			lastControllerId = -1;
			Trigger = new Timer(new TimerCallback(TimerCallback), null, 0, STimSettings.UploadPeriod);
