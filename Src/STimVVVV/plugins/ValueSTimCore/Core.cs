...
using VVVV.STim.Nodes.Status;
using System.IO;
using VVVV.STim.Nodes.Attention;
...
namespace VVVV.STim.Nodes
{
	public class Core : INotifyPropertyChanged
	{
		...
		private double CalculateBlockPercentage(DepthImageFrame depthFrame)
		{
			...
			return DepthPercentF.ProcessNewPercentageData(rawPercent, STimSettings.BlockPercentBufferSize);
		}
